...
/*!****************************************************************************
 *
 * \fn xLCD_Get_Length(void)
 *
 * \brief Function to get the amount of space left on the current line
 *
 * \details Function is called to calculate the amount of characters remaining
 *			on the LCD using the cursor's coordinates.
 *
 *			This allows for tracking the amount of space available.

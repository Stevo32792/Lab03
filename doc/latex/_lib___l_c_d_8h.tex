...
Definition at line 520 of file Lib\-\_\-\-L\-C\-D.\-c.


\begin{DoxyCode}
521 \{
522     \textcolor{comment}{//save the current position}
523     \textcolor{keyword}{register} uint8\_t DDRAMAddr;
524     
525     \textcolor{comment}{// For each line o the LCD}
526     \textcolor{keywordflow}{switch}(y)
527     \{
528         \textcolor{keywordflow}{case} 0: 
529             \textcolor{comment}{//for the top line, set the DDRAM address }
530             \textcolor{comment}{//move a certain number of characters to the right}
531             DDRAMAddr = LCD\_LINE0\_DDRAMADDR + x;
532         \textcolor{keywordflow}{break};
533         
534         \textcolor{keywordflow}{case} 1: 
535             \textcolor{comment}{//for the bottom line, set the DDRAM address }
536             \textcolor{comment}{//move a certain number of characters to the right}
537             DDRAMAddr = LCD\_LINE1\_DDRAMADDR + x;
538         \textcolor{keywordflow}{break};
539         
540         \textcolor{keywordflow}{default}: 
541             \textcolor{comment}{//default to the top left of the LCD if nothing is specified}
542             DDRAMAddr = LCD\_LINE0\_DDRAMADDR+x;
543     \}
544     
545     \textcolor{comment}{//save current cursor position X}
546     \hyperlink{_lib___l_c_d_8h_af3836e0e465249949a42c1711a29b026}{CURSOR\_X\_POSITION} = x;
547     \textcolor{comment}{//save current cursor position Y}
548     \hyperlink{_lib___l_c_d_8h_aa8060b8676b9666d5b1357bb896a7cfa}{CURSOR\_Y\_POSITION} = y;
549     
550     \textcolor{comment}{// send a command to set the data address}
551     \hyperlink{_lib___l_c_d_8c_a03a66d0dc99ddbf838e4699cb1f0c568}{vWRITE\_COMMAND\_TO\_LCD}(INSTR\_WR, 1 <<LCD\_DDRAM | DDRAMAddr);
552 \}
\end{DoxyCode}
...
Definition at line 604 of file Lib\-\_\-\-L\-C\-D.\-c.


\begin{DoxyCode}
605 \{
606     \textcolor{comment}{//move the cursor to the bottom left position on the LCD}
607     \hyperlink{_lib___l_c_d_8c_a3d78bee51edcb0ebe6cf4936147bb207}{vLCD\_GO\_TO\_POSITION}(0,1);
608 \}
\end{DoxyCode}
...
Definition at line 576 of file Lib\-\_\-\-L\-C\-D.\-c.


\begin{DoxyCode}
577 \{
578     \textcolor{comment}{//move cursor to the top left position of the LCD}
579     \hyperlink{_lib___l_c_d_8c_a03a66d0dc99ddbf838e4699cb1f0c568}{vWRITE\_COMMAND\_TO\_LCD}(INSTR\_WR, 1 << \hyperlink{_lib___l_c_d_8h_a207e17a2f807f034c0fc055010928a16}{LCD\_HOME\_TOP\_LINE});
580 \}
\end{DoxyCode}
...
\begin{DoxyCode}
473 \{
474     \textcolor{keywordflow}{switch}(\hyperlink{_lib___l_c_d_8h_aa8060b8676b9666d5b1357bb896a7cfa}{CURSOR\_Y\_POSITION})
475     \{
477         \textcolor{keywordflow}{case} 0:
479             \textcolor{keywordflow}{return} 48 - \hyperlink{_lib___l_c_d_8h_af3836e0e465249949a42c1711a29b026}{CURSOR\_X\_POSITION}; 
480             \textcolor{keywordflow}{break};
481             
483         \textcolor{keywordflow}{case} 1:
485             \textcolor{keywordflow}{return} 24 - \hyperlink{_lib___l_c_d_8h_af3836e0e465249949a42c1711a29b026}{CURSOR\_X\_POSITION}; 
486     \}
487 \}
\end{DoxyCode}
